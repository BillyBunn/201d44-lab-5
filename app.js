...
function sumArray(sumArr) { //eslint-disable-line
    var sumOutput = sum(sum(testArray[0], testArray[1])[0], testArray[2])[0];
    var message = `${testArray} was passed in as an array of numbers, and ${sumOutput} is their sum.`;
    return [sumOutput, message];
}
...
function multiplyArray(multArr) { //eslint-disable-line
    var productOutput = multiply(multiply(testArray[0], testArray[1])[0], testArray[2])[0];
    var message = `The numbers ${multArr} have a product of ${productOutput}.`;
    return [productOutput, message];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    for (var i = 0; i < dynamicArray.length; i++) {
        productOutput = multiply(productOutput, dynamicArray[i])[0];
    }
    var message = `The numbers ${dynamicArray} have a product of ${productOutput}.`;
    return [productOutput, message];
}
